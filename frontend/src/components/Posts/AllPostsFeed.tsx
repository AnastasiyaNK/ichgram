...
//         <div className={styles.postCaption}>
//           <span className={styles.captionUsername}>{post.author.name}</span>
//           <span className={`${styles.captionText} ${isExpanded ? styles.expanded : ''}`}>
//             {post.description}
//           </span>
...
const AllPostsFeed: React.FC<AllPostsFeedProps> = ({ post, onLike }) => {
  ...
  // Безпечне отримання даних автора
  const author = post.author || { _id: 'unknown', name: 'Unknown User', profileImage: null };
